...
import parkingCars from '../../assets/parking cars 2.jpeg'
  ...
  return (
    <div>
      <div className={classes.pageNameDiv}>
        <img className={classes.pageNameImg} src={parkingCars} alt="parking cars"/>
        <h2 className={classes.pageName}>Our Cars</h2>
      </div>
